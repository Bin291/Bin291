...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>🗂️ FormCV</h3>
      <p><strong>AI-powered CV Builder Platform</strong></p>
      <p>Hệ thống tạo CV tự động với AI, phục vụ hơn <strong>5.000+ người dùng</strong>.</p>
      <ul>
        <li>🎯 Thuật toán phân tích CV chính xác lên đến <strong>85%</strong></li>
        <li>⏱️ Tiết kiệm <strong>30%</strong> thời gian tuyển dụng cho HR</li>
        <li>📈 Tối ưu hóa hồ sơ ứng viên bằng công nghệ AI</li>
      </ul>
      <p>
      ...
      <a href="https://formcv.app/">🔗 formcv.app</a>
    </td>
    <td width="50%" valign="top">
      <h3>🏢 Partner Tenant System</h3>
      <p><strong>Multi-tenant B2B Platform for FormCV</strong></p>
      <p>Hệ thống cho phép doanh nghiệp hợp tác và đăng ký gói đặc biệt qua domain riêng.</p>
      <ul>
        <li>📊 RESTful API xử lý <strong>10.000+ requests/ngày</strong></li>
        <li>⚡ Uptime đảm bảo <strong>99.5%</strong> availability</li>
        <li>📈 Tỷ lệ giữ chân người dùng tăng <strong>30%</strong></li>
      </ul>
      <p>
      ...
      <a href="https://partner.formcv.app/">🔗 partner.formcv.app</a>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Nền tảng nghe nhạc trực tuyến với real-time audio processing.</p>
      <ul>
        <li>🎧 Hỗ trợ <strong>1.000+ người dùng</strong> đồng thời</li>
        <li>📈 Tăng <strong>30%</strong> user engagement</li>
        <li>🎙️ Upload audio chất lượng cao với UX thân thiện</li>
      </ul>
      <p>
      ...
      <a href="https://rhyza-732bd.web.app">🔗 rhyza-732bd.web.app</a>
    </td>
    <td width="50%" valign="top">
      <h3>💼 Open to Collaborate!</h3>
      <p>Tôi luôn tìm kiếm những dự án thú vị để đóng góp.</p>
      <br/>
      <p>Nếu bạn có ý tưởng về:</p>
      <ul>
        <li>🔧 Backend systems & APIs</li>
        <li>🗄️ Database architecture</li>
        <li>⚙️ Full-stack web apps</li>
      </ul>
      <br/>
      <p>→ <a href="mailto:binhnguyen290104@gmail.com">Liên hệ với tôi nhé!</a></p>
    </td>
  </tr>
</table>
